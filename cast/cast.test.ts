namespace $ {
	...
	$mol_test({
		...
		'Reg <=> Dict'( $ ) {
			...
			dict.dive( 2, $hyoo_cras_reg ).value_vary( 'foo' )
			...
			reg.value_vary( 3 )
			$mol_assert_like( dict.dive( 2, $hyoo_cras_reg ).value_vary(), null )
			$mol_assert_like( dict.dive( 3, $hyoo_cras_reg ).value_vary(), 'foo' )
