...
declare namespace $ {
    ...
    class $hyoo_crus_unit extends $mol_buffer {
        ...
        id12(offset: number, next?: string): string;
        _peer: string;
...
declare namespace $ {
    ...
    export type $hyoo_crus_vary_type = null | Uint8Array | bigint | $mol_time_moment | $mol_tree2 | json | Node;
...
declare namespace $ {
    ...
    class $hyoo_crus_gist extends $hyoo_crus_unit {
        ...
        hint(tip?: "bin" | "bool" | "int" | "real" | "str" | "time" | "json" | "xml" | "tree", tag?: "keys" | "vals" | "head" | "term"): void;
        tip(): "bin" | "bool" | "int" | "real" | "str" | "time" | "json" | "xml" | "tree";
        pic(): boolean;
        utf(): boolean;
        ...
        hash(next?: Uint8Array, tip?: "bin" | "bool" | "int" | "real" | "str" | "time" | "json" | "xml" | "tree", tag?: "keys" | "vals" | "head" | "term"): Uint8Array;
        meta(): Uint8Array;
        data(next?: Uint8Array, tip?: "bin" | "bool" | "int" | "real" | "str" | "time" | "json" | "xml" | "tree", tag?: "keys" | "vals" | "head" | "term"): Uint8Array;
        idea(): number;
...
declare namespace $ {
    type $hyoo_crus_face_data = Iterable<readonly [string, number]>;
    class $hyoo_crus_face extends Map<string, number> {
        last: number;
        constructor(entries?: $hyoo_crus_face_data);
        sync(right: $hyoo_crus_face_data): void;
        see_time(time: number): void;
        see_peer(peer: string, time: number): void;
...
declare namespace $ {
    class $hyoo_crus_node extends $mol_object {
        ...
        can_change(lord?: string): boolean;
    }
}
...
declare namespace $ {
    class $hyoo_crus_land extends $mol_object {
        ...
        gifts: $mol_wire_dict<string, $hyoo_crus_gift>;
        ...
        total(): number;
        joined_list(): string[];
        lord_rang(lord: string): $hyoo_crus_rang;
        ...
        join(): $hyoo_crus_pass;
        give(dest: string, rang: $hyoo_crus_rang): $hyoo_crus_gift;
...
declare namespace $ {
    class $hyoo_crus_yard extends $mol_object {
        ...
        static load(land: $hyoo_crus_land): readonly $hyoo_crus_unit[];
        static save(land: $hyoo_crus_land, units: readonly $hyoo_crus_unit[]): Promise<void>;
    }
}
...
declare namespace $ {
    class $hyoo_crus_realm extends $mol_object {
        lords: $mol_wire_dict<string, $hyoo_crus_lord>;
        home(): $hyoo_crus_lord;
...
declare namespace $ {
    class $hyoo_crus_text extends $hyoo_crus_list {
        ...
        selection(lord: string, next?: readonly [number, number]): number[] | readonly [number, number];
    }
}
...
declare namespace $ {
    function $hyoo_crus_dict_obj<Schema extends Record<string, typeof $hyoo_crus_node>>(schema: Schema): Pick<typeof $hyoo_crus_dict, typeof Symbol.toPrimitive | "toString" | "destructor" | "$" | "toJSON" | "prototype" | "tag" | "make" | "create"> & (new () => $hyoo_crus_dict & { [Key in keyof Schema]: InstanceType<Schema[Key]>; } & { [Key_1 in keyof Schema as Lowercase<Extract<Key_1, string>>]: (next?: ReturnType<InstanceType<Schema[Key_1]>["value"]> | undefined) => ReturnType<InstanceType<Schema[Key_1]>["value"]> | null; });
}

declare namespace $ {
    const $hyoo_crus_entity_base: Pick<typeof $hyoo_crus_dict, typeof Symbol.toPrimitive | "toString" | "destructor" | "$" | "toJSON" | "prototype" | "tag" | "make" | "create"> & (new () => $hyoo_crus_dict & {
