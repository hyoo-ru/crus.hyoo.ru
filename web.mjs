...
(function ($) {
    class $hyoo_crus_flex_thing extends $hyoo_crus_dict.with({
        Kind: $hyoo_crus_reg_ref_to(() => $hyoo_crus_flex_kind),
        Title: $hyoo_crus_reg_str,
    }) {
    }
    ...
    class $hyoo_crus_flex_prop extends $hyoo_crus_flex_thing.with({
        ...
        Target: $hyoo_crus_reg_ref_to(() => $hyoo_crus_flex_kind),
        Enum: $hyoo_crus_reg_ref_to(() => $hyoo_crus_list_vary),
        Base: $hyoo_crus_reg_vary,
    }) {
    }
...
(function ($) {
    ...
    (function ($$) {
        class $hyoo_crus_flex_field extends $.$hyoo_crus_flex_field {
            ...
            ref(next) {
                return this.node(next)?.cast($hyoo_crus_reg_vary).value(next) ?? null;
            }
            ref_options() {
